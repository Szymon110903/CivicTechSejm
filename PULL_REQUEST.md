...
*   **`GET /api/clubs` (Clubs Overview)**: Agregates average cohesion (discipline), attendance, majority support rate, and decision breakdown (`YES`, `NO`, `ABSTAIN`, `MIXED`) across all clubs.
